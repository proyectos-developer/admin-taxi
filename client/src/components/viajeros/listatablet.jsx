...
import CardViajeroTablet from './cards/viajerotablet.jsx'
                        ...
                        lista_usuarios.map ((usuario, numusua) => {
                            return (
                                <div key={numusua} className='d-flex' 
                                    ...
                                    {
                                        usuarios[(2 *  numusua)] ? ( 
                                            <CardViajeroTablet usuario={usuarios[(2 *  numusua)]} key={(2 *  numusua)} index={(2 *  numusua)} proporcional={proporcional}/>
                                        ) : null
                                    }
                                    {
                                        usuarios[(2 *  numusua) + 1] ? ( 
                                            <CardViajeroTablet usuario={usuarios[(2 *  numusua) + 1]} key={(2 *  numusua) + 1} index={(2 *  numusua) + 1} proporcional={proporcional}/>
                                        ) : null
                                    }
                                </div>
                            )
