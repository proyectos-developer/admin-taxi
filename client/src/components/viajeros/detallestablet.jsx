...
export default function DetallesViajeroTablet({proporcional}) {
        ...
        <div className='' style={{width: 976 / proporcional, paddingLeft: 50 / proporcional, paddingRight: 50 / proporcional, paddingTop: 50 / proporcional,
          paddingBottom: 50 / proporcional}}>
            <div className='d-flex' style={{width: 876 / proporcional, height: 'auto', marginBottom: 12.5 / proporcional}}>
                <div className='' style={{width: 200 / proporcional, marginRight: 20 / proporcional}}>
                    <div className='shadow bg-white rounded-circle'
                        ...
                        <img src={foto === '' ? icon_conductor : foto} style={{width: 198 / proporcional, height: 198 / proporcional}} alt='' className='rounded-circle'/>
                    </div>
                </div>
            ...
            <div className='' style={{width: 876 / proporcional}}>
                    <div className='d-flex justify-content-end' style={{width: 876 / proporcional, height: 50 / proporcional, marginBottom: 15 / proporcional}}>
                    ...
                    <div className='d-flex shadow-sm bg-white rounded' style={{width: 876 / proporcional, height: 50 / proporcional, border: '1px solid #B2DFDB', 
                                                    borderRadius: 4 / proporcional}}>
                        <p style={{fontFamily: 'Mukta, sans-serif', width: 98 / proporcional, height: 48 / proporcional, fontSize: 16 / proporcional, 
            ...
            <div className='d-flex justify-content-end' style={{width: 876 / proporcional, height: 50 / proporcional, marginTop: 25 / proporcional}}>
