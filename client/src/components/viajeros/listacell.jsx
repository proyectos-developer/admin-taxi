...
import CardViajeroCell from './cards/viajerocell.jsx'

export default function ListaViajerosCell({proporcional}) {
    ...
    useEffect (() => {
        if (get_viajeros_filtro_total && get_viajeros_filtro_total.viajeros && get_viajeros_filtro_total.success === true){
            ...
            setListaViajeros (get_viajeros_filtro_total.viajeros)
        }
        ...
        <div className='position-relative' style={{width: 499 / proporcional, paddingLeft: 20 / proporcional, paddingRight: 20 / proporcional}}>
            <div className='d-flex' style={{width: 459 / proporcional, height: 50 / proporcional, marginBottom: 25 / proporcional }}>
                ...
                <p className='mb-0' 
                    ...
                    del {begin} al {begin + usuarios.length} de {total_usuarios}
                </p>
                        ...
                        lista_usuarios.map ((usuario, numusua) => {
                            return (
                                <div key={numusua} className='d-flex' 
                                    ...
                                    <CardViajeroCell usuario={usuario} key={numusua} index={numusua} proporcional={proporcional}/>
                                </div>
                            )
                        })
                    ) : null
