...
export default function CardCalificacion({calificacion, index, proporcional}) {
    ...
    return (
        <div key={index} className='position-relative shadow-lg bg-body rounded default' 
            ...
            <div key={index} className='position-relative' 
                ...
                <div className='d-flex' style={{width: 330 / proporcional, height: 100 / proporcional}}>
                    ...
                    <div style={{width: 220 / proporcional, height: 100 / proporcional}}>
                        ...
                        <div className='d-flex' style={{width: 220 / proporcional, height: 20 / proporcional}}>
