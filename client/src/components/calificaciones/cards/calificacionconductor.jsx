...
export default function CardCalificacionConductor({calificacion, index, proporcional}) {
    ...
    return (
        <div key={index} className='position-relative shadow-lg bg-body rounded default' 
            style={{width: 700 / proporcional, height: 120 / proporcional, marginLeft: 20 / proporcional, marginRight: 20 / proporcional, 
                    borderRadius: 4 / proporcional, border: '1px solid #757575'}}>
            <div key={index} className='position-relative' 
                style={{width: 700 / proporcional, height: 'auto', borderRadius: 4 / proporcional, padding: 10 / proporcional}}>
                <div className='d-flex' style={{width: 680 / proporcional, height: 100 / proporcional}}>
                    ...
                    <div style={{width: 570 / proporcional, height: 100 / proporcional}}>
                        ...
                        <div className='d-flex' style={{width: 570 / proporcional, height: 20 / proporcional}}>
