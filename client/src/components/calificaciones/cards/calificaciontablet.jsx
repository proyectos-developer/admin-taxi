...
export default function CardCalificacionTablet({calificacion, index, proporcional}) {
    ...
    return (
        <div key={index} className='position-relative shadow-lg bg-body rounded default' 
            style={{width: 418 / proporcional, height: 120 / proporcional, marginLeft: 10 / proporcional, marginRight: 10 / proporcional, 
            ...
            <div key={index} className='position-relative' 
                ...
                <div className='d-flex' style={{width: 398 / proporcional, height: 100 / proporcional}}>
                    ...
                    <div style={{width: 288 / proporcional, height: 100 / proporcional}}>
                        ...
                        <div className='d-flex' style={{width: 288 / proporcional, height: 20 / proporcional}}>
