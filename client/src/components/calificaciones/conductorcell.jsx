...
import CardCalificacionConductorCell from './cards/calificacionconductorcell.jsx'
...
export default function CalificacionesConductorCell({proporcional}) {
    ...
    return ( 
        <div className='position-relative' style={{width: 499 / proporcional, paddingLeft: 20 / proporcional, paddingRight: 20 / proporcional}}>
            <div className='d-flex' style={{width: 459 / proporcional, height: 50 / proporcional, marginBottom: 12.5 / proporcional }}>
                <p className='mb-0' 
                        ...
                        lista_calificaciones.map ((calificacion, numcal) => {
                            return (
                                <div key={numcal} className='d-flex' 
                                    ...
                                    <CardCalificacionConductorCell calificacion={calificacion} key={numcal} index={numcal} proporcional={proporcional}/>
                                </div>
                            )
                        })
                    ) : null
