...
import CardCalificacionConductor from './cards/calificacionconductor.jsx'
...
export default function CalificacionesConductor({proporcional}) {
    ...
    useEffect (() => {
        if (get_calificaciones_conductor && get_calificaciones_conductor.calificaciones && get_calificaciones_conductor.success === true){
            let data = get_calificaciones_conductor.calificaciones.length
            let lista = []
    ...
    return ( 
        <div className='position-relative' style={{width: 1920 / proporcional, paddingLeft: 240 / proporcional, paddingRight: 240 / proporcional}}>
            <div className='d-flex' style={{width: 1480 / proporcional, height: 50 / proporcional, marginBottom: 12.5 / proporcional }}>
                                ...
                                <div key={numcal} className='d-flex' 
                                    style={{marginBottom: 12.5 / proporcional}}>
                                    {
                                        calificaciones[(4 *  numcal)] ? ( 
                                            <CardCalificacionConductor calificacion={calificaciones[(4 *  numcal)]} key={(4 *  numcal)} index={(4 *  numcal)} proporcional={proporcional}/>
                                        ) : null
                                    }
                                    {
                                        calificaciones[(4 *  numcal) + 1] ? ( 
                                            <CardCalificacionConductor calificacion={calificaciones[(4 *  numcal) + 1]} key={(4 *  numcal) + 1} index={(4 *  numcal) + 1} proporcional={proporcional}/>
                                        ) : null
                                    }
                                    {
                                        calificaciones[(4 *  numcal) + 2] ? ( 
                                            <CardCalificacionConductor calificacion={calificaciones[(4 *  numcal) + 2]} key={(4 *  numcal) + 2} index={(4 *  numcal) + 2} proporcional={proporcional}/>
                                        ) : null
                                    }
                                    {
                                        calificaciones[(4 *  numcal) + 3] ? ( 
                                            <CardCalificacionConductor calificacion={calificaciones[(4 *  numcal) + 3]} key={(4 *  numcal) + 3} index={(4 *  numcal) + 3} proporcional={proporcional}/>
                                        ) : null
                                    }
                                </div>
                            )
