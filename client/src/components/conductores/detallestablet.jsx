...
export default function DetallesConductorTablet({proporcional}) {
    ...
    return (
        <div className='' style={{width: 976 / proporcional, paddingLeft: 50 / proporcional, paddingRight: 50 / proporcional, paddingTop: 50 / proporcional,
          paddingBottom: 50 / proporcional}}>
            <div className='d-flex' style={{width: 876 / proporcional, height: 'auto', marginBottom: 12.5 / proporcional}}>
                <div className='' style={{width: 200 / proporcional, marginRight: 20 / proporcional}}>
                    <div className='shadow bg-white rounded-circle'
                        style={{width: 200 / proporcional, height: 200 / proporcional, border: '1px solid #B2DFDB', padding: 2 / proporcional, cursor: 'pointer'}}>
                        <img src={foto_perfil === '' ? icon_conductor : foto_perfil} style={{width: 192 / proporcional, height: 192 / proporcional}} alt='' className='rounded-circle'/>
                    </div>
                </div>
                <div className='' style={{width: 656 / proporcional}}>
                    <div className='d-flex justify-content-between' style={{width: 656 / proporcional, height: 50 / proporcional, marginBottom: 16.66 / proporcional}}>
                        <div className='d-flex shadow-sm bg-white rounded' style={{width: 313 / proporcional, height: 50 / proporcional, marginRight: 15 / proporcional, border: enombres ? '1px solid red' : '1px solid #B2DFDB', 
                            ...
                            <input type='text'
                                disabled={true}
                                style={{fontFamily: 'Mukta, sans-serif', width: 205 / proporcional, height: 46 / proporcional, fontSize: 18 / proporcional, lineHeight: `${46 / proporcional}px`,
                        ...
                        <div className='d-flex shadow-sm bg-white rounded' style={{width: 313 / proporcional, height: 50 / proporcional, marginLeft: 15 / proporcional, border: '1px solid #B2DFDB', 
                                                        borderRadius: 4 / proporcional}}>
                            <p style={{fontFamily: 'Mukta, sans-serif', width: 98 / proporcional, height: 48 / proporcional, fontSize: 16 / proporcional, 
                    ...
                    <div className='d-flex' style={{width: 656 / proporcional, height: 50 / proporcional, marginBottom: 16.66 / proporcional}}>
                        <div className='d-flex shadow-sm bg-white rounded' style={{width: 313 / proporcional, height: 50 / proporcional, marginRight: 15 / proporcional, border: '1px solid #B2DFDB', 
                                                        borderRadius: 4 / proporcional}}>
                            <p style={{fontFamily: 'Mukta, sans-serif', width: 98 / proporcional, height: 48 / proporcional, fontSize: 16 / proporcional, 
                        ...
                        <div className='d-flex shadow-sm bg-white rounded' style={{width: 313 / proporcional, height: 50 / proporcional, marginLeft: 15 / proporcional, border: enro_documento ? '1px solid red' : '1px solid #B2DFDB', 
                                                        borderRadius: 4 / proporcional}}>
                            <p style={{fontFamily: 'Mukta, sans-serif', width: 98 / proporcional, height: 48 / proporcional, fontSize: 16 / proporcional, 
                    ...
                    <div className='d-flex' style={{width: 656 / proporcional, height: 50 / proporcional, marginBottom: 16.66 / proporcional}}>
                        ...
                        <div className='d-flex shadow-sm bg-white rounded' style={{width: 313 / proporcional, height: 50 / proporcional, marginLeft: 15 / proporcional, border: enro_telefono ? '1px solid red' : '1px solid #B2DFDB', 
                                                        borderRadius: 4 / proporcional}}>
                            <p style={{fontFamily: 'Mukta, sans-serif', width: 98 / proporcional, height: 48 / proporcional, fontSize: 16 / proporcional, 
                            ...
                            <PhoneInput
                                disabled={true}
                                id='nro_telefono'
                                style={{fontFamily: 'Mukta, sans-serif', width: 205 / proporcional, height: 46 / proporcional, fontSize: 18 / proporcional, lineHeight: `${46 / proporcional}px`, fontWeight: 500, color: '#212121',
            ...
            <div className='' style={{width: 876 / proporcional}}>
                <div className='d-flex justify-content-end' style={{width: 876 / proporcional, height: 50 / proporcional, marginBottom: 12.5 / proporcional}}>
                    <div className='d-flex shadow-sm bg-white rounded' style={{width: 656 / proporcional, height: 50 / proporcional, border: ecorreo ? '1px solid red' : '1px solid #B2DFDB', 
                                                    borderRadius: 4 / proporcional}}>
                ...
                <div className='d-flex' style={{width: 876 / proporcional, height: 50 / proporcional, marginBottom: 12.5 / proporcional}}>
                    <div className='d-flex shadow-sm bg-white rounded' style={{width: 277 / proporcional, height: 50 / proporcional, marginRight: 15 / proporcional, border: '1px solid #B2DFDB', 
                                                    borderRadius: 4 / proporcional}}>
                        <p style={{fontFamily: 'Mukta, sans-serif', width: 98 / proporcional, height: 48 / proporcional, fontSize: 16 / proporcional, 
                        ...
                        <input
                            type='text'
                            disabled={true}
                            style={{fontFamily: 'Mukta, sans-serif', width: 169 / proporcional, height: 46 / proporcional, fontSize: 18 / proporcional, lineHeight: `${46 / proporcional}px`,
                                    fontWeight: 500, color: '#212121', cursor: 'default'}}
                    ...
                    <div className='d-flex shadow-sm bg-white rounded' style={{width: 277 / proporcional, height: 50 / proporcional, marginLeft: 7.665 / proporcional, 
                    ...
                    <div className='d-flex shadow-sm bg-white rounded' style={{width: 277 / proporcional, height: 50 / proporcional, marginLeft: 15 / proporcional, border: enombres ? '1px solid red' : '1px solid #B2DFDB', 
                                                    borderRadius: 4 / proporcional}}>
                        <p style={{fontFamily: 'Mukta, sans-serif', width: 98 / proporcional, height: 48 / proporcional, fontSize: 16 / proporcional, 
                ...
                <div className='d-flex' style={{width: 656 / proporcional, height: 50 / proporcional, marginBottom: 12.5 / proporcional}}>
                    <div className='d-flex shadow-sm bg-white rounded' style={{width: 277 / proporcional, height: 50 / proporcional, marginRight: 15 / proporcional, border: '1px solid #B2DFDB', 
                                                    borderRadius: 4 / proporcional}}>
                        <p style={{fontFamily: 'Mukta, sans-serif', width: 98 / proporcional, height: 48 / proporcional, fontSize: 16 / proporcional, 
                    ...
                    <div className='d-flex shadow-sm bg-white rounded' style={{width: 277 / proporcional, height: 50 / proporcional, marginLeft: 15 / proporcional, border:'1px solid #B2DFDB', 
                                                    borderRadius: 4 / proporcional}}>
                        <p style={{fontFamily: 'Mukta, sans-serif', width: 98 / proporcional, height: 48 / proporcional, fontSize: 16 / proporcional, 
                ...
                <div className='d-flex' style={{width: 656 / proporcional, height: 50 / proporcional, marginBottom: 12.5 / proporcional}}>
                    <div className='d-flex shadow-sm bg-white rounded' style={{width: 277 / proporcional, height: 50 / proporcional, marginRight: 15 / proporcional, border: '1px solid #B2DFDB', 
                        ...
                        <input
                            ...
                            style={{fontFamily: 'Mukta, sans-serif', width: 205 / proporcional, height: 47 / proporcional, fontSize: 18 / proporcional, lineHeight: `${46 / proporcional}px`, fontWeight: 500, color: '#212121',
                                    borderWidth: 0}}
                        />
                    </div>
                    <div className='d-flex shadow-sm bg-white rounded' style={{width: 277 / proporcional, height: 50 / proporcional, marginLeft: 7.665 / proporcional, 
            ...
            <div className='d-flex' style={{width: 876 / proporcional, height: 'auto', marginBottom: 12.5 / proporcional}}>
                <div className='' style={{width: 423 / proporcional, marginRight: 15 / proporcional}}>
                    <div className='shadow bg-white rounded'
                        style={{width: 423 / proporcional, height: 250 / proporcional, border: '2px dashed #B2DFDB', padding: 2 / proporcional}}>
                        <img src={foto_documento === '' ? icon_documento : foto_documento} 
                            style={{width: foto_documento === '' ? 128 / proporcional : 205 / proporcional, height: 128 / proporcional, marginLeft: 147.5 / proporcional,
                            marginRight: 147.5 / proporcional, marginTop: 61 / proporcional, marginBottom: 61 / proporcional}} alt=''/>
                    </div>
                </div>
                <div className='' style={{width: 423 / proporcional, marginLeft: 15 / proporcional}}>
                    <div className='shadow bg-white rounded'
                        style={{width: 423 / proporcional, height: 250 / proporcional, border: '2px dashed #B2DFDB', padding: 2 / proporcional}}>
                        <img src={foto_licencia === '' ? icon_licencia : foto_licencia} 
                            style={{width: foto_licencia === '' ? 128 / proporcional : 205 / proporcional, height: 128 / proporcional, marginLeft: 147.5 / proporcional,
                            marginRight: 147.5 / proporcional, marginTop: 61 / proporcional, marginBottom: 61 / proporcional}} alt=''/>
                    </div>
                </div>
            </div>
            <div className='d-flex justify-content-end' style={{width: 876 / proporcional, height: 50 / proporcional}}>
                <div className='d-flex justify-content-center' style={{width: 423 / proporcional}}>
                    <button className='btn text-icons shadow rounded' 
                            ...
                            style={{fontFamily: 'PT Serif, sans-serif', width: boton_volver ? 475 / proporcional : 423 / proporcional, height: 50 / proporcional, fontWeight: 500,
