...
export default function CardConductorTablet({conductor, index, proporcional}) {
    ...
    return (
        <div key={index} className='position-relative shadow bg-body rounded default' 
            style={{width: 417 / proporcional, height: 120 / proporcional, marginLeft: 10 / proporcional, marginRight: 10 / proporcional, 
                    borderRadius: 4 / proporcional, border: '1px solid #757575'}}
                    onMouseOver={() => setVer(true)} onMouseLeave={() => setVer(false)}>
            <div key={index} className='position-relative' 
                style={{width: 417 / proporcional, height: 'auto', borderRadius: 4 / proporcional, padding: 10 / proporcional}}>
                <div className='d-flex' style={{width: 397 / proporcional / proporcional, height: 100 / proporcional}}>
                    ...
                    <div style={{width: 397 / proporcional, height: 100 / proporcional, marginLeft: 5 / proporcional}}>
