...
export default function ModalNuevoCell({tosave, proporcional}) {
    ...
    return (
        <div className='position-absolute h-100 top-0 start-0' 
            style={{width: 499 / proporcional, background: 'rgba(189, 189, 189, 0.6)',
                    height: 'auto', top: 0 / proporcional, right: 0 / proporcional}}>
            <div id='nuevo-conductor' className='shadow-lg rounded position-fixed' 
                    style={{width: 459 / proporcional, background: 'white', zIndex: 99999, padding: 10 / proporcional, top: 100 / proporcional, right: 0 / proporcional, height: 'auto'}}>
                ...
                <div className='d-flex' style={{width: 439 / proporcional, height: 100 / proporcional, marginBottom: 12.5 / proporcional}}>
                    <div style={{width: 100 / proporcional, height: 100 / proporcional, border: '1px solid #9E9E9E', borderRadius: 4 / proporcional, 
                                    padding: 2 / proporcional}}>
                        <img src={tosave.foto_perfil === '' ? icon_conductor : tosave.foto_perfil} alt='' 
                             style={{width: 94 / proporcional, height: 94 / proporcional, border: 4 / proporcional}}/>
                    </div>
                    <div style={{width: 487 / proporcional, height: 'auto', marginLeft: 10 / proporcional}}>
                ...
                <div className='' style={{width: 439 / proporcional, height: 'auto', marginBottom: 12.5 / proporcional}}>
                    <div className='d-flex justify-content-between' style={{width: 477 / proporcional}}>
                        <p className='mb-0' style={{width: 219.5 / proporcional, fontFamily: 'Mukta, sans-serif', fontWeight: 700, color: '#212121', fontSize: 16 / proporcional, lineHeight: `${20 / proporcional}px`, height: 20 / proporcional}}>
                ...
                <button className='btn dark-primary text-icons' onClick={() => {dispatch(set_conductor_new({success: '0'})); window.scrollTo(0, 0); setBotonSalir(false)}} 
                        ...
                        style={{fontFamily: 'PT Serif, serif', width: 439 / proporcional, marginBottom: 12.5 / proporcional, height: 40 / proporcional, fontSize: 16 / proporcional, lineHeight: `${20 / proporcional}px`,
                ...
                <button className='btn dark-primary text-icons' onClick={() => {{dispatch(set_conductor_new({success: '1'})); window.scrollTo(0, 0)}; setBotonGuardar(false);
                        ...
                        style={{fontFamily: 'PT Serif, serif', width: 439 / proporcional, marginBottom: 12.5 / proporcional, height: 40 / proporcional, 
