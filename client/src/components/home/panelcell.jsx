...
export default function HomePanelCell({proporcional}) {
  ...
  return (
    <div style={{width: 499 / proporcional}}>
        <div className='position-relative' style={{width: 499 / proporcional, height: 75 / proporcional, background: '#212121', paddingTop: 12.5 / proporcional,
            ...
            <p onClick={() => navigate ('/home')} className='position-absolute top-50 start-50 translate-middle'
              style={{fontSize: 38 / proporcional, lineHeight: `${48 / proporcional}px`, color: 'rgba(189, 189, 189, 0.6)', fontWeight: 700 / proporcional, cursor: 'pointer',
                     height: 62 / proporcional, padding: 5 / proporcional}}>
                TAXI 24/7 hr
            </p>
            <p onClick={() => navigate ('/home')} className='position-absolute top-50 start-50 translate-middle'
              style={{fontSize: 36 / proporcional, lineHeight: `${46 / proporcional}px`, color: 'white', fontWeight: 700 / proporcional, cursor: 'pointer',
        ...
        {
          open ? (
            <div style={{width: 400 / proporcional, background: 'rgba(39, 39, 39, 0.9)', height: '100%', padding: 20 / proporcional, top: 75 / proporcional,
                zIndex: 99999}} 
