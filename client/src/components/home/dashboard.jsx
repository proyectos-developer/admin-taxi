...
export default function HomeDashboard({proporcional}) {
  ...
  return (
    <div className='' 
      style={{width: 1480 / proporcional, marginLeft: 220 / proporcional,
              marginRight: 220 / proporcional, paddingTop: 50 / proporcional, paddingBottom: 50 / proporcional}}>
      <div className='d-flex' style={{width: 1480 / proporcional, marginBottom: 100 / proporcional}}>
        ...
        <div className='d-flex' style={{width: 1480 / proporcional, marginTop: 100 / proporcional}}>
          <div style={{width: 250 / proporcional, height: 300 / proporcional,
