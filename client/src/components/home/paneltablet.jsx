...
export default function HomePanelTablet({proporcional}) {
  ...
  return (
    <div style={{width: 976 / proporcional}}>
        <div className='position-relative' style={{width: 976 / proporcional, height: 75 / proporcional, background: '#212121', paddingTop: 12.5 / proporcional,
        ...
        {
          open ? (
            <div style={{width: 300 / proporcional, background: 'rgba(39, 39, 39, 0.9)', height: '100%', padding: 20 / proporcional, top: 75 / proporcional,
                zIndex: 99999}} 
