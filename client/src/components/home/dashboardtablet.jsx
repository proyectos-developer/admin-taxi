...
export default function HomeDashboardTablet({proporcional}) {
  ...
  return (
    <div className='' style={{width: 976 / proporcional, paddingLeft: 113 / proporcional, paddingRight: 113 / proporcional, paddingTop: 50 / proporcional,
      paddingBottom: 50 / proporcional}}>
      <div className='d-flex' style={{width: 750 / proporcional, marginBottom: 100 / proporcional}}>
      ...
      <div className='d-flex' style={{width: 750 / proporcional, marginTop: 100 / proporcional}}>
          <div style={{width: 250 / proporcional, height: 300 / proporcional, marginRight: 125 / proporcional}}>
            <div className='shadow-lg rounded-circle position-relative' 
