...
export default function DetallesViajeTablet({proporcional}) {
  ...
  return (
    <div className='' style={{width: 976 / proporcional, paddingLeft: 50 / proporcional, paddingRight: 50 / proporcional, paddingTop: 50 / proporcional,
          ...
          <div className='' style={{width: 876 / proporcional, height: 'auto', marginBottom: 12.5 / proporcional}}>
              <div style={{width: 876 / proporcional, height: 480 / proporcional}}>
                  ...
                  <div className='d-flex justify-content-between' style={{width: 876 / proporcional, height: 24 / proporcional, marginBottom: 10 / proporcional}}>
                  ...
                  <div className='' style={{width: 876 / proporcional, height: 2 / proporcional, marginBottom: 10 / proporcional, background: 'rgba(39, 39, 39, 0.4)'}}/>
                  ...
                  <div className='d-flex justify-content-end' style={{width: 876 / proporcional, height: 24 / proporcional, marginBottom: 10 / proporcional}}>
                    <p className='' style={{fontFamily: 'Lora, serif', fontWeight: 700, color: '#212121', fontSize: 18 / proporcional, 
                                                lineHeight: `${24 / proporcional}px`, textAlign: 'start', height: 24 / proporcional, marginBottom: 10 / proporcional}}>
                  ...
                  <div className='' style={{width: 876 / proporcional, height: 2 / proporcional, marginBottom: 10 / proporcional, background: 'rgba(39, 39, 39, 0.4)'}}/>
                  <div className='d-flex' style={{width: 876 / proporcional, height: 24 / proporcional, marginBottom: 10 / proporcional}}>
              ...
              <div style={{width: 876 / proporcional, height: 876 / proporcional}}>
                  <GoogleMapReact
          ...
          <div className='d-flex justify-content-end' style={{width: 876 / proporcional, height: 50 / proporcional}}>
              <button className='btn' 
                  ...
                  style={{width: boton_volver ? 438 / proporcional : 436 / proporcional, height: 50 / proporcional, background: '#212121', color: 'white', 
