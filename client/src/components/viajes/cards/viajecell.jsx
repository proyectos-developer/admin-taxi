...
export default function CardViajeCell({viaje, index, proporcional}) {
    ...
    return (
        <div key={index} className='position-relative shadow-lg bg-body rounded default' 
            style={{width: 439 / proporcional, height: 'auto', marginLeft: 10 / proporcional, marginRight: 10 / proporcional, 
            ...
            <div key={index} className='position-relative' 
                ...
                <div className='' style={{width: 309 / proporcional, height: 'auto'}}>
