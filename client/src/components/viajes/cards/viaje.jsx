...
export default function CardViaje({viaje, index, proporcional}) {
    ...
    return (
        <div key={index} className='position-relative shadow-lg bg-body rounded default' 
            style={{width: 350 / proporcional, height: 'auto', marginLeft: 10 / proporcional, marginRight: 10 / proporcional, 
            ...
            <div key={index} className='position-relative' 
                ...
                <div className='' style={{width: 330 / proporcional, height: 'auto'}}>
                    <div className='d-flex justify-content-between' style={{width: 330 / proporcional, height: 20 / proporcional}}>
                    ...
                    <div className='d-flex' style={{width: 330 / proporcional, height: 25 / proporcional, marginBottom: 5 / proporcional}}>
                    ...
                    <div className='d-flex justify-content-end' style={{width: 330 / proporcional, height: 25 / proporcional, marginBottom: 5 / proporcional}}>
                        <p className='mb-0' style={{fontFamily: 'Lora, serif', fontWeight: 700, color: '#212121', fontSize: 16 / proporcional, lineHeight: `${25 / proporcional}px`, textAlign: 'end', height: 20 / proporcional}}>
