...
import CardViajeTablet from './cards/viajetablet.jsx'

export default function ListaViajesTablet({proporcional}) {
                        ...
                        lista_viajes.map ((viaje, numviaje) => {
                            return (
                                <div key={numviaje} className='d-flex' 
                                    ...
                                    {
                                        viajes[(2 *  numviaje)] ? ( 
                                            <CardViajeTablet viaje={viajes[(2 *  numviaje)]} key={(2 *  numviaje)} index={(2 *  numviaje)} proporcional={proporcional}/>
                                        ) : null
                                    }
                                    {
                                        viajes[(2 *  numviaje) + 1] ? ( 
                                            <CardViajeTablet viaje={viajes[(2 *  numviaje) + 1]} key={(2 *  numviaje) + 1} index={(2 *  numviaje) + 1} proporcional={proporcional}/>
                                        ) : null
                                    }
                                </div>
                            )
