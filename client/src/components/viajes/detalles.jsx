...
export default function DetallesViaje({proporcional}) {
  ...
  return (
    <div className='' style={{width: 1920 / proporcional, paddingLeft: 460 / proporcional, paddingRight: 460 / proporcional, paddingTop: 50 / proporcional,
          ...
          <div className='d-flex' style={{width: 1000 / proporcional, height: 'auto', marginBottom: 12.5 / proporcional}}>
              <div style={{width: 480 / proporcional, height: 480 / proporcional, marginRight: 20 / proporcional}}>
                  <GoogleMapReact
              ...
              <div style={{width: 480 / proporcional, height: 480 / proporcional, marginLeft: 20 / proporcional, marginTop: 12 / proporcional, marginBottom: 12 / proporcional}}>
                  ...
                  <div className='d-flex justify-content-between' style={{width: 480 / proporcional, height: 24 / proporcional, marginBottom: 10 / proporcional}}>
                  ...
                  <div className='' style={{width: 480 / proporcional, height: 2 / proporcional, marginBottom: 10 / proporcional, background: 'rgba(39, 39, 39, 0.4)'}}/>
                  ...
                  <div className='d-flex justify-content-end' style={{width: 480 / proporcional, height: 24 / proporcional, marginBottom: 10 / proporcional}}>
                    <p className='' style={{fontFamily: 'Lora, serif', fontWeight: 700, color: '#212121', fontSize: 18 / proporcional, 
                                                lineHeight: `${24 / proporcional}px`, textAlign: 'start', height: 24 / proporcional, marginBottom: 10 / proporcional}}>
                  ...
                  <div className='' style={{width: 480 / proporcional, height: 2 / proporcional, marginBottom: 10 / proporcional, background: 'rgba(39, 39, 39, 0.4)'}}/>
                  <div className='d-flex' style={{width: 480 / proporcional, height: 24 / proporcional, marginBottom: 10 / proporcional}}>
                  ...
                  <div className='d-flex justify-content-between' style={{width: 240 / proporcional, height: 24 / proporcional, marginBottom: 10 / proporcional}}>
                    <p className='mb-0' style={{fontFamily: 'Lora, serif', fontWeight: 700, color: '#212121', fontSize: 18 / proporcional, 
                                                lineHeight: `${24 / proporcional}px`, textAlign: 'start', height: 24 / proporcional}}>
          ...
          <div className='d-flex justify-content-end' style={{width: 1000 / proporcional, height: 50 / proporcional}}>
              <button className='btn' 
                  ...
                  style={{width: boton_volver ? 240 / proporcional : 238 / proporcional, height: 50 / proporcional, background: '#212121', color: 'white', 
